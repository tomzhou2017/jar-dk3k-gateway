...
public class Property {
	...
	private void setFieldValue(Class<?> modelClass, PropertyDescriptor propertyDescriptor) {
			for(; modelClass != Object.class ; modelClass = modelClass.getSuperclass()) {
				try {
	...
	public Property(Class<?> modelClass, PropertyDescriptor propertyDescriptor) {
		...
		setFieldValue(modelClass, propertyDescriptor);
