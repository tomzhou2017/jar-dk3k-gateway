...
import com.dk3k.framework.core.mybatis.annotation.AutoId;
import com.dk3k.framework.core.mybatis.utils.DateUtils;
import com.dk3k.framework.core.mybatis.utils.ReflectUtils;
import org.apache.commons.lang3.StringUtils;
import org.apache.ibatis.jdbc.SQL;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import com.dk3k.framework.core.dto.LoginUserDto;
import com.dk3k.framework.core.entity.BaseEntity;
import com.dk3k.framework.core.mybatis.complexQuery.CustomQueryParam;
import com.dk3k.framework.core.mybatis.complexQuery.NoValueQueryParam;
import com.dk3k.framework.core.mybatis.complexQuery.WithValueQueryParam;
//import com.dk3k.framework.utils.SessionUtils;
...
public class BaseProvider<T extends BaseEntity> {
    ...
    private void initFromThreadLocal() {
        ...
        // 批量插入时，数据库是否自增id
        AutoId autoId = modelClass.getAnnotation(AutoId.class);
        if(autoId != null){
            this.autoId = autoId.value();
        }
    }
    ...
    public String countLike(T findParams)
    ...
    public String insertBatch(final Map<String, List<T>> param) throws IllegalAccessException, InvocationTargetException, NoSuchFieldException {
        ...
        Map<String, Property> result = ModelUtils.getProperties(cla, null);
        // 如果是自动id,那么不需要设置id
        if(autoId){
            result.remove("id");
        }

        final Map<String, Property> properties = result;
        SQL sql = new SQL() {
            {
                INSERT_INTO(tableName);
                for (Property property : properties.values()) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            while (iterator.hasNext()) {
                ...
                // logger.debug("========insertBatch field
                // name:{},type:{},value:{}", fieldName, type, val);
        ...
        String sql = new SQL() {
            {
                ...
                Map<String, Field> fieldMap = ReflectUtils.getBeanPropertyFieldsMap(t.getClass(),true);
                for (Property property : properties.values()) {
