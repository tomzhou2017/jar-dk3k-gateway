package com.dk3k.framework.server.netty.spring;
 ...
 * 	url root: /democenter/
 * 	com.mobanker.democenter.api.controller.OrderController 类的RequestMapping值为:order, 某成员方法的RequestMapping值为: /getOrder, 则 转换后的完整url为: /order/getOrder
 * 	com.mobanker.democenter.api.controller.v2_1_7.OrderController 类的RequestMapping值为order, 某成员方法的RequestMapping值为: /getOrder, 则 转换后的完整url为: /2.1.7/order/getOrder
