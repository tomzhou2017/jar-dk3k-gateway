...
import com.dk3k.framework.server.netty.config.ServerConfig;
import com.dk3k.framework.server.netty.initializer.ChannelInitializerWrapper;
import com.dk3k.framework.server.netty.initializer.HttpChannelInitializer;
...
public class NettyServerBootstrap {
	...
	/**定义spring 全局配置文件 父容器  默认 * 代表项目名称 如：mobanker-demo-application.xml*/
	public static final String SPRING_APPLICATION_CONFIG = "classpath*:/dk3k-*-application.xml";
	/**定义spring 全局配置文件servletmvc 子容器 默认 * 代表项目名称 如：mobanker-demo-servlet.xml*/
	public static final String SPRING_SERVLET_CONFIG = "classpath*:/dk3k-*-servlet.xml";
	public static final String SERVER_PROPERTIES = "/configs/server.properties";
