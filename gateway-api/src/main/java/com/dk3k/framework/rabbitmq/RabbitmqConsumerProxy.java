...
public class RabbitmqConsumerProxy implements ChannelAwareMessageListener, InitializingBean {
    ...
    private ChannelAwareMessageProcesser channelAwareMessageProcesser;
    ...
    public void onMessage(final Message message, final Channel channel) throws Exception {
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    channelAwareMessageProcesser.processMessage(message, channel);
   ...
   /* @Override
    ...
    public ChannelAwareMessageProcesser getChannelAwareMessageProcesser() {
        return channelAwareMessageProcesser;
    }

    public void setChannelAwareMessageProcesser(ChannelAwareMessageProcesser channelAwareMessageProcesser) {
        this.channelAwareMessageProcesser = channelAwareMessageProcesser;
    }
}
